...
* todo
** cicada-nymph 的關於棧的 macro
** stores platform as variable
...
* -----------------------------------
* marco for print_argument_stack
 #+begin_src fasm :tangle cicada-nymph.fasm
   ;; match =64bit, machine {
   ...
   ;;    macro temp_address register \{
   ;;       mov register,address$argument_stack
   ;;    \}
...
** little_test
   ...
   define_function "little_test", little_test
      ...
      ;;;; print_argument_stack
      ;; xx literal, 2
      ;; xx literal, 4
      ;; xx print_argument_stack
      ;; xx zero
      ;; xx exit_with_TOS
      ;;;; exit ocde : 0
...
* print_argument_stack
 #+begin_src fasm :tangle cicada-nymph.fasm
   ;; define_primitive_function "pointer_address", pointer_address
   ;;    temp_address rbx
   ;;    push_argument_stack rbx
   ;;    pointer rax
   ;;    push_argument_stack rax
   ...
   ;; define_primitive_function "pointer_to_number", pointer_to_number
   ...
   ;; define_primitive_function "pointer_sub1", pointer_sub1
   ;;    ;; << pointer -- pointer-josize >>
   ;;    pop_argument_stack rax
   ;;    sub rax, jo_size
   ;;    push_argument_stack rax
   ;;    next     
   
   ;; define_function "print_argument_stack", print_argument_stack
   ;;       ;; << print all the number in the argument stack >>
   ;;       xx pointer_address ;; << address,pointer -->>
   ;;       xx help__print
   
   ;; define_function "help__print", help__print
   ;;       xx dup2, equal?, false?branch, 2
   ;;       xx end
   ;;       xx pointer_to_number, write_byte
   ;;       xx pointer_sub1
   ;;       xx taca, help__print
 #+end_src
* -----------------------------------
